...
/* en esta función estoy tomando un selector como entrada y determino el tipo de selector que es según
las indicaciones del Readme.
 Si el selector comienza con #, se considera un selector de ID y devuelve 'id'. 
Si comienza con ., se considera un selector de clase y devuelve 'class'. 
Si está entre corchetes [...], se considera un selector de atributo y devuelve 'attribute'.
Si contiene :, se considera un pseudo-selector y devuelve 'pseudo-class'. De lo contrario, 
se considera un selector de elemento y devuelve 'element'. */
